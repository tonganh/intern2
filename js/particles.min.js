...
var pJS = function(e, a) {
  ...
  this.pJS = {
    ...
    particles: {
      ...
      line_linked:
          {enable: !0, distance: 100, color: '#fff', opacity: 1, width: 1},
      move: {
        enable: !0,
        speed: 2,
        direction: 'none',
  ...
  a && Object.deepExtend(i, a),
     ...
     i.fn.retinaInit = function() {
       ...
       i && i.interactivity.events.resize &&
           window.addEventListener('resize', function() {
             ...
             i.particles.move.enable ||
                 (i.fn.particlesEmpty(), i.fn.particlesCreate(),
                  i.fn.particlesDraw(), i.fn.vendors.densityAutoParticles()),
       ...
       if (this.radius = (i.particles.size.random ? Math.random() : 1) *
         ...
         if (e.value instanceof Array) {
           var s = e.value[Math.floor(
               Math.random() * i.particles.color.value.length)];
           this.color.rgb = hexToRgb(s)
         } else
           void 0 != e.value.r && void 0 != e.value.g && void 0 != e.value.b &&
               (this.color.rgb = {r: e.value.r, g: e.value.g, b: e.value.b}),
               void 0 != e.value.h && void 0 != e.value.s &&
               void 0 != e.value.l &&
       ...
       i.particles.move.straight ? (this.vx = n.x, this.vy = n.y,
       ...
       switch (i.canvas.ctx.fillStyle = n, i.canvas.ctx.beginPath(), a.shape) {
         ...
         case 'triangle':
           i.fn.vendors.drawShape(
               i.canvas.ctx, a.x - t, a.y + t / 1.66, 2 * t, 3, 2);
           break;
         case 'polygon':
           i.fn.vendors.drawShape(
               i.canvas.ctx,
       ...
       for (var e = 0; e < i.particles.array.length; e++) {
         ...
         switch (a.x - a.radius > i.canvas.w ?
           ...
           case 'bounce':
             a.x + a.radius > i.canvas.w ? a.vx = -a.vx :
       ...
       cancelRequestAnimFrame(i.fn.checkAnimFrame),
           ...
           i.tmp.source_svg = void 0, i.tmp.img_obj = void 0,
           i.tmp.count_svg = 0, i.fn.particlesEmpty(), i.fn.canvasClear(),
           i.fn.vendors.start()
       ...
       if (n <= i.particles.line_linked.distance) {
         ...
         if (r > 0) {
           ...
           i.canvas.ctx.lineTo(a.x, a.y), i.canvas.ctx.stroke(),
           i.canvas.ctx.closePath()
         }
       }
           ...
           if (i.tmp.bubble_duration_end) {
             if (void 0 != s) {
               var o = n - p * (n - a) / i.interactivity.modes.bubble.duration,
                   l = a - o;
               d = a + l, 'size' == c && (e.radius_bubble = d),
       ...
       if (i.interactivity.events.onhover.enable &&
           isInArray('bubble', i.interactivity.events.onhover.mode)) {
         ...
         if (r <= i.interactivity.modes.bubble.distance) {
           if (c >= 0 && 'mousemove' == i.interactivity.status) {
             ...
             if (i.interactivity.modes.bubble.opacity !=
                 i.particles.opacity.value)
               if (i.interactivity.modes.bubble.opacity >
                   i.particles.opacity.value) {
         ...
         i.tmp.bubble_clicking &&
             (t(i.interactivity.modes.bubble.size, i.particles.size.value,
                e.radius_bubble, e.radius, 'size'),
              t(i.interactivity.modes.bubble.opacity, i.particles.opacity.value,
                e.opacity_bubble, e.opacity, 'opacity'))
       }
     }, i.fn.modes.repulseParticle = function(e) {
       function a() {
         var a = Math.atan2(d, p);
         if (e.vx = u * Math.cos(a), e.vy = u * Math.sin(a),
             'bounce' == i.particles.move.out_mode) {
           var t = {x: e.x + e.vx, y: e.y + e.vy};
           t.x + e.radius > i.canvas.w ? e.vx = -e.vx :
       ...
       if (i.interactivity.events.onhover.enable &&
         ...
         var t = e.x - i.interactivity.mouse.pos_x,
             ...
             n = Math.sqrt(t * t + s * s), r = {x: t / n, y: s / n},
         ...
         'bounce' == i.particles.move.out_mode ?
             (v.x - e.radius > 0 && v.x + e.radius < i.canvas.w && (e.x = v.x),
              v.y - e.radius > 0 && v.y + e.radius < i.canvas.h &&
                  (e.y = v.y)) :
             (e.x = v.x, e.y = v.y)
       } else if (
           i.interactivity.events.onclick.enable &&
         ...
         if (i.tmp.repulse_finish ||
           ...
           var c = Math.pow(i.interactivity.modes.repulse.distance / 6, 3),
               ...
               d = i.interactivity.mouse.click_pos_y - e.y, m = p * p + d * d,
               u = -c / m * 1;
           c >= m && a()
         } else
       ...
       if (i.interactivity.events.onhover.enable &&
         ...
         if (s <= i.interactivity.modes.grab.distance) {
           ...
           if (n > 0) {
             ...
             i.canvas.ctx.beginPath(), i.canvas.ctx.moveTo(e.x, e.y),
             i.canvas.ctx.lineTo(
                 i.interactivity.mouse.pos_x, i.interactivity.mouse.pos_y),
       ...
       'window' == i.interactivity.detect_on ?
           ...
           i.interactivity.el.addEventListener('click', function() {
             if (i.interactivity.mouse.click_pos_x =
               ...
               switch (i.interactivity.events.onclick.mode) {
                 ...
                 case 'bubble':
                   ...
                   break;
                 case 'repulse':
                   i.tmp.repulse_clicking = !0, i.tmp.repulse_count = 0,
                   i.tmp.repulse_finish = !1, setTimeout(function() {
       ...
       if (i.particles.number.density.enable) {
         ...
         0 > t ? i.fn.modes.pushParticles(Math.abs(t)) :
                 i.fn.modes.removeParticles(t)
       }
     }, i.fn.vendors.checkOverlap = function(e, a) {
       for (var t = 0; t < i.particles.array.length; t++) {
         var s = i.particles.array[t], n = e.x - s.x, r = e.y - s.y,
             c = Math.sqrt(n * n + r * r);
         c <= e.radius + s.radius &&
       ...
       o.addEventListener('load', function() {
         e.img.obj = o, e.img.loaded = !0, r.revokeObjectURL(c),
         i.tmp.count_svg++
       }), o.src = c
     }, i.fn.vendors.destroypJS = function() {
       cancelAnimationFrame(i.fn.drawAnimFrame), t.remove(), pJSDom = null
     }, i.fn.vendors.drawShape = function(e, a, t, i, s, n) {
       var r = s * n, c = s / n, o = 180 * (c - 2) / c,
       ...
       if (i.tmp.img_error = void 0, '' != i.particles.shape.image.src)
         ...
         console.log('Error%20pJS%20-%20No%20image.html'), i.tmp.img_error = !0
       ...
       'image' == i.particles.shape.type ?
           ...
           i.tmp.img_error ||
                       (i.fn.drawAnimFrame =
                            requestAnimFrame(i.fn.vendors.draw)) :
       ...
       i.fn.retinaInit(), i.fn.canvasInit(), i.fn.canvasSize(),
           i.fn.canvasPaint(), i.fn.particlesCreate(),
           i.fn.vendors.densityAutoParticles(),
           i.particles.line_linked.color_rgb_line =
