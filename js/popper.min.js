...
function h(e, t, o, n) {
  return $(
      ...
      o['scroll' + e],
      r(10) ?
          o['offset' + e] + n['margin' + ('Height' === e ? 'Top' : 'Left')] +
...
function b(e, o) {
  ...
  if (b.marginTop = 0, b.marginLeft = 0, !p && s) {
    ...
    b.top -= h - y, b.bottom -= h - y, b.left -= c - w, b.right -= c - w,
        b.marginTop = y, b.marginLeft = w
  }
...
function y(e) {
  var t = 1 < arguments.length && void 0 !== arguments[1] && arguments[1],
      ...
      r = $(o.clientHeight, window.innerHeight || 0), p = t ? 0 : l(o),
      s = t ? 0 : l(o, 'left'), d = {
...
function k() {
  if (!this.state.isDestroyed) {
    ...
    e.offsets.reference =
        L(this.state, this.popper, this.reference, this.options.positionFixed),
    e.placement =
...
function F() {
  this.state.eventsEnabled ||
      (this.state =
           I(this.reference, this.options, this.state, this.scheduleUpdate))
}
function R(e, t) {
...
function z(e) {
  var t = 1 < arguments.length && void 0 !== arguments[1] && arguments[1],
      o = me.indexOf(e), n = me.slice(o + 1).concat(me.slice(0, o));
...
for (var J = Math.min, Q = Math.round, Z = Math.floor, $ = Math.max,
         ...
         te = ['Edge', 'Trident', 'Firefox'], oe = 0, ne = 0;
     ne < te.length; ne += 1)
    ...
    de =
      ...
      function e(e, t) {
        for (var o, n = 0; n < t.length; n++)
          o = t[n], o.enumerable = o.enumerable || !1, o.configurable = !0,
          'value' in o && (o.writable = !0), Object.defineProperty(e, o.key, o)
      }
    ...
    ce = function() {
      function t(o, n) {
        ...
        se(this, t),
            ...
            this.popper = n && n.jquery ? n[0] : n, this.options.modifiers = {},
            Object.keys(le({}, t.Defaults.modifiers, r.modifiers))
                .forEach(function(e) {
                  i.options.modifiers[e] =
                      le({}, t.Defaults.modifiers[e] || {},
         ...
         modifiers: {
           ...
           preventOverflow: {
             ...
             fn: function(e, t) {
               ...
               i.top = '', i.left = '', i[n] = '';
               var a =
                   v(e.instance.popper, e.instance.reference, t.padding, o,
                     e.positionFixed);
           ...
           arrow: {
             ...
             fn: function(e, o) {
               ...
               d[c] -
                       u<s[m] && (e.offsets.popper[m] -= s[m] - (d[c] - u)),
                         d[m] + u>s[c] &&
                   (e.offsets.popper[m] += d[m] + u - s[c]),
                   e.offsets.popper = g(e.offsets.popper);
               var b = d[m] + d[l] / 2 - u / 2, y = t(e.instance.popper),
                   w = parseFloat(y['margin' + f], 10),
                   E = parseFloat(y['border' + f + 'Width'], 10),
                   v = b - e.offsets.popper[m] - w - E;
               return v = $(J(s[l] - u, v), 0), e.arrowElement = i,
                      e.offsets.arrow =
           ...
           flip: {
             ...
             fn: function(e, t) {
               ...
               var o =
                       v(e.instance.popper, e.instance.reference, t.padding,
               ...
               return p.forEach(function(s, d) {
                 ...
                 var a = e.offsets.popper, l = e.offsets.reference, f = Z,
                     ...
                     'bottom' === n &&
                         f(a.top)<
                             f(l.bottom), h = f(a.left) < f(o.left),
                 ...
                 (m || b || w) &&
                     (e.flipped = !0, (m || b) && (n = p[d + 1]),
                      w && (r = G(r)), e.placement = n + (r ? '-' + r : ''),
                      e.offsets.popper =
                          le({}, e.offsets.popper,
                             C(e.instance.popper, e.offsets.reference,
                               e.placement)),
           ...
           computeStyle: {
             ...
             fn: function(e, t) {
               ...
               if (d = 'bottom' == c ? -f.height + h.bottom : h.top,
                   s = 'right' == g ? -f.width + h.right : h.left, a && b)
           ...
           applyStyle: {
             ...
             onLoad: function(e, t, o, n, i) {
               var r = L(i, t, e, o.positionFixed),
                   p = O(
                       o.placement, r, t, e, o.modifiers.flip.boundariesElement,
