...
!(function(e, n, t, o) {
  ...
  e.fn.pagepiling = function(i) {
    ...
    function c(n, t) {
      ...
      if (!o.activeSection.is(n)) {
        'undefined' == typeof o.animated && (o.animated = !0),
            ...
            'down' === o.yMovement ?
            ((o.translate3d = U()), (o.scrolling = '-100%'),
             Z.css3 || o.sectionsToMove.each(function(n) {
            ...
            ((o.translate3d = 'translate3d(0px, 0px, 0px)'),
             (o.scrolling = '0'), (o.animateSection = n)),
            e.isFunction(Z.onLeave) &&
            Z.onLeave.call(
                this, o.leavingSection, o.sectionIndex + 1, o.yMovement),
            r(o), A(o.anchorLink), z(o.anchorLink, o.sectionIndex),
            (W = o.anchorLink);
          ...
          ((n.scrollOptions = u(n.scrolling)),
           n.animated ?
               n.animateSection.animate(
                   n.scrollOptions, Z.scrollingSpeed, Z.easing,
                   function() {
                     d(n), l(n);
                   }) :
    ...
    function f(n) {
      (n = n.replace('#', '')),
          (e('body')[0].className =
               e('body')[0].className.replace(/\b\s?pp-viewing-[^\s]+\b/g, '')),
          e('body').addClass('pp-viewing-' + n);
    }
    function h() {
      var o = t.location.hash.replace('#', ''), i = o,
    ...
    function g() {
      var o = t.location.hash.replace('#', '').split(
              'https://html.gridbootstrap.com/'),
          i = o[0];
      if (i.length && i && i !== W) {
        var a;
        (a = isNaN(i) ? e(n).find('[data-anchor="' + i + '"]') :
                        e('.pp-section').eq(i - 1)),
            c(a);
      }
    }
    ...
    function b(n) {
      ...
      var i = n.wheelDelta || -n.deltaY || -n.detail,
          ...
          s = 'undefined' != typeof n.wheelDeltaX ||
          'undefined' != typeof n.deltaX,
          c = Math.abs(n.wheelDeltaX) < Math.abs(n.wheelDelta) ||
          Math.abs(n.deltaX) < Math.abs(n.deltaY) || !s;
      G.length > 149 && G.shift(), G.push(Math.abs(i));
      var r = o - _;
      if (((_ = o), r > 200 && (G = []), !m())) {
        var l = e('.pp-section.active'), p = T(l), d = y(G, 10), u = y(G, 70),
            v = d >= u;
    ...
    function x(e, n) {
      var t, o;
      if (('down' == e ? ((t = 'bottom'), (o = B.moveSectionDown)) :
    ...
    function I(e) {
      var n = new Array();
      return (
          (n.y = 'undefined' != typeof e.pageY && (e.pageY || e.pageX) ?
               e.pageY :
               e.touches[0].pageY),
    ...
    function z(n, t) {
      Z.navigation &&
          (e('#pp-nav').find('.active').removeClass('active'),
           n ? e('#pp-nav').find('a[href="#' + n + '"]').addClass('active') :
               e('#pp-nav').find('li').eq(t).find('a').addClass('active'));
    }
    function A(n) {
      Z.menu &&
          (e(Z.menu).find('.active').removeClass('active'),
           e(Z.menu).find('[data-menuanchor="' + n + '"]').addClass('active'));
    }
    function O() {
    ...
    function U() {
      return 'vertical' !== Z.direction ? 'translate3d(-100%, 0px, 0px)' :
                                          'translate3d(0px, -100%, 0px)';
    }
    var W, B = e.fn.pagepiling, F = e(this), Q = 0,
           R = 'ontouchstart' in t || navigator.msMaxTouchPoints > 0 ||
        navigator.maxTouchPoints,
           j = 0, H = 0, K = 0, V = 0, G = [], J = 600,
           Z = e.extend(
               !0, {
                 direction: 'vertical',
                 menu: null,
    ...
    e.extend(e.easing, {
      easeInQuart: function(e, n, t, o, i) {
        ...
        (B.setMouseWheelScrolling =
             function(e) {
               e ? k() : C();
             }),
        (B.setAllowScrolling =
             function(e) {
               e ? (B.setMouseWheelScrolling(!0), E()) :
                   (B.setMouseWheelScrolling(!1), L());
             }),
        (B.setKeyboardScrolling =
             function(e) {
        ...
        (B.moveTo =
             function(t) {
               var o = '';
               (o = isNaN(t) ? e(n).find('[data-anchor="' + t + '"]') :
                               e('.pp-section').eq(t - 1)),
                   o.length > 0 && c(o);
             }),
    ...
    e('.pp-section')
        .each(function(n) {
          e(this).data('data-index', n), e(this).css('z-index', $),
              n || 0 !== e('.pp-section.active').length ||
              ...
              Z.verticalCentered && !e(this).hasClass('pp-scrollable') &&
              a(e(this)),
              ($ -= 1);
        })
        .promise()
        .done(function() {
          Z.navigation &&
              (e('#pp-nav').css(
                   'margin-top', '-' + e('#pp-nav').height() / 2 + 'px'),
               e('#pp-nav')
                   .find('li')
        ...
        e(n).on(
            {
              mouseenter: function() {
                ...
                e('<div class="pp-tooltip ' + Z.navigation.position + '">' + n +
                  '</div>')
                    .hide()
                    .appendTo(e(this))
                    .fadeIn(200);
